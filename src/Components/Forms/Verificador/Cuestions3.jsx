...
const Cuestions3 = ({ formik }) => {
	const Data = [
		{ label: '¿La población objetivo de la institución coincide con lo asentado en al cédula de registro?', id: 'c3_0' },
...
Cuestions3.propTypes = {
	formik: PropTypes.element.isRequired,
};

export default Cuestions3;
