...
const Cuestions4 = ({ formik }) => {
	const Data = [
		{ label: '¿Los servicios que brinda la institución, coinciden con los asentado en la cédula de registro?', id: 'c4_0' },
...
Cuestions4.propTypes = {
	formik: PropTypes.element.isRequired,
};

export default Cuestions4;
